        ...
        <div class="sm:flex sm:gap-4">
          @if(auth()->check() && auth()->user()->role == 'user')
            ...
            <div class="hidden sm:flex">
              <a class="rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600" href="{{ route('logout') }}"
          ...
          @else
            <a class="rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white shadow" href="{{ route('get-signin') }}">
              Login
            </a>
            <div class="hidden sm:flex">
              <a class="rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600" href="{{ route('get-signup') }}">
                Register
              </a>
            </div>
          @endif
