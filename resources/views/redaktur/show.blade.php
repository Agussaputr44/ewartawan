...
@section('content')
    <div class="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <p class="text-gray-700 mb-2">Kategori: <span class="font-semibold">{{ $berita->kategori->nama_kategori }}</span>
            </p>
            ...
            @if (auth()->check() && auth()->user()->role == 'wartawan')
                <a href="{{ route('berita.index') }}"
                    class="inline-block px-6 py-2 text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-sm">Kembali</a>
            @else
